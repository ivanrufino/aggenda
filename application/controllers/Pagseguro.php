...
class Pagseguro extends CI_Controller{
    ...
    public function __construct() {
      ...
      // $this->load->library('pagseguro2');
     //  $this->load->library('teste');
    }
    ...
    public function index(){
      //  $this->teste->testar();
        ...
        $this->pagseguros->set_user($usuario);
        ...
        $this->pagseguros->set_products($products);
        
        // ID do pedido
        $config['reference'] = rand(999, 9999);

        // gera botão
        echo $this->pagseguros->get_button($config);
    }
    ...
    public function retorno_pagseguro() {
        ...
        if (count($_POST) > 0) {
            ...
            $retorno = $this->pagseguros->notificationPost();
            ...
            if ($notificationType && $notificationCode) {
                ...
                $not = $this->pagseguros->get_notification($notificationCode);
                /*
    ...
    public function check($code = NULL) {        
        ...
        $string = $this->pagseguros->get_notification($code);
